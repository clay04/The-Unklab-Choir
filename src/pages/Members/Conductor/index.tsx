  ...
  return (
    <View style={styles.container}>
      <LinearGradient colors={['#530303', '#000000', '#000000']} style={styles.gradient}>
        <Header label="Conductor" backButton={true} onPress={() => navigation.goBack()}/>
        <Gap height={50} />
        <View style={{alignItems: 'center'}}>
            <Image source={FotTUC} style={styles.profilePicture}/>
            <Gap height={25} />
            <View style={styles.containerWrapp}>
                <Text style={styles.name}>Brianna Alexandra Rhebok</Text>
                ...
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    ...
                    <Text style={styles.label1}>@briannalexandra</Text>
                </View>
            </View>
        </View>
      </LinearGradient>
